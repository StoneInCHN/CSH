...
@Entity
@Table (name = "csh_beautify_reservation")
@SequenceGenerator (name = "sequenceGenerator", sequenceName = "csh_beautify_reservation_sequence")
public class BeautifyReservation extends BaseEntity
{
  ...
  @Index (name = "beautifyReservation_tenantid")
  @Field(index = org.hibernate.search.annotations.Index.UN_TOKENIZED, store = Store.NO)
