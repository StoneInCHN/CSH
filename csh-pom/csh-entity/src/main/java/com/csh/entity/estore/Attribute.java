 ...
 */
@Entity
@Table(name = "csh_attribute",indexes={@Index(name="attribute_tenantid",columnList="tenantID")})
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "csh_attribute_sequence")
public class Attribute extends OrderEntity {
  ...
  private Long tenantID;
	...
	@NotEmpty
	@ElementCollection
	@CollectionTable(name = "csh_attribute_option")
