...
<head>
<title>${message("csh.main.reportDeviceBind")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						<a ><i class="fa fa-user"></i> ${message("csh.main.report")}</a> 
						<span class="divider">/</span> 
						<a  class="bread-current"><i class="fa fa-pencil-square-o"></i>${message("csh.report.reportDeviceBind")}</a>
					</div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("csh.report.reportDeviceBind")}</div>
