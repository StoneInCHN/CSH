...
<head>
<title>${message("csh.parameterGroup.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("csh.parameterGroup.list")}(${message("csh.page.total", page.total)})</span>
					</div>
						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "name" ] selected="selected" class="active" [/#if] title="name"><a href="#">${message("csh.parameterGroup.name")}</a></li>
								        </ul>
								      </div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("csh.main.parameterGroup")}</div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="name">${message("csh.parameterGroup.name")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="parent">${message("csh.parameterGroup.productCategory")}</a>
													</th>
													<th>
														<span>${message("csh.parameterGroup.parameters")}</span>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="name">${message("csh.common.order")}</a>
													</th>
													<th>
											...
											<tbody>
													[#list page.content as parameterGroup]
														<tr>
															...
															<td>
																[#if parameterGroup.productCategory]${parameterGroup.productCategory.name}[#else]--[/#if]
															</td>
															<td>
															...
															<td>
																<a href="edit.jhtml?id=${parameterGroup.id}" title="${message("csh.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
															</td>
														</tr>
													[/#list]
											</tbody>
