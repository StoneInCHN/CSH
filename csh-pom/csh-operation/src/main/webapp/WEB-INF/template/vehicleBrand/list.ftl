...
<head>
<title>${message("csh.vehicleBrand.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("csh.vehicleBrand.list")}(${message("csh.page.total", page.total)})</span>
					</div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("csh.main.vehicleBrand")}</div>
						              ...
						              <div class="widget-content">
										<table id="listTable" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												[#list page.content as vehicleBrand]
												<tr>
													<td>
														<input type="checkbox"  name="ids" value="${vehicleBrand.id}" />
													</td>
													<td>
														${vehicleBrand.code}
													</td>
													...
													<td>
														<a href="edit.jhtml?id=${vehicleBrand.id}" title="${message("csh.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
													</td>
												</tr>
												[/#list]
											</tbody>
