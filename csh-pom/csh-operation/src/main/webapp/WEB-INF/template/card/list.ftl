...
<body>
	<div class="path">
		${message("asup.current.position")}：${message("asup.card.manage")}&raquo; ${message("asup.card.list")} <span>(${message("asup.page.total", page.total)})</span>
	</div>
	<form id="listForm" action="list.jhtml" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="imagePath">${message("asup.card.imagePath")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="createDate">${message("asup.card.createDate")}</a>
				</th>
				<th>
					<a href="javascript:;" name="serviceName">${message("asup.card.servicename")}</a>
				</th>
				<th>
					<a href="javascript:;" name="vendorName">${message("asup.card.vendorname")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="effictiveFrom">${message("asup.card.startDate")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="effictiveTo">${message("asup.card.endDate")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="status">${message("asup.card.status")}</a>
				</th>
				<th>
			...
			[#list page.content as card]
				<tr>
					...
					<td>
						[#if card.status = 'approvedPass']
							-
						[#else]
							<a href="review.jhtml?id=${card.id}">[${message("asup.card.review")}]</a>
						[/#if]
					</td>
				</tr>
			[/#list]
