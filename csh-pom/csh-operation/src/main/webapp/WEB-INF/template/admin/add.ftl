...
<body>
	...
	<form id="inputForm" action="save.jhtml" method="post">
		...
		<table class="input tabContent">
			<tr>
				<th>
					<span class="requiredField">*</span>${message("asup.admin.username")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("asup.admin.password")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("asup.admin.rePassword")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("asup.admin.email")}:
				</th>
				<td>
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("asup.admin.adminStatus")}:
				</th>
				<td>
					<input type="radio" value="actived" name="adminStatus" checked="checked" />${message("asup.admin.adminStatus.actived")}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="radio" value="locked" name="adminStatus" />${message("asup.admin.adminStatus.locked")}
				</td>
			</tr>
		</table>
		<table class="input">
