...
<head>
<title>${message("csh.brand.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("csh.brand.list")}(${message("csh.page.total", page.total)})</span>
					</div>
						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "name" ] selected="selected" class="active" [/#if] title="name"><a href="#">${message("csh.brand.name")}</a></li>
								        </ul>
								      </div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("csh.main.brand")}</div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="name">${message("csh.brand.name")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="logo">${message("csh.brand.logo")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="url">${message("csh.brand.url")}</a>
													</th>
													<th>
														<a href="javascript:;" class="sort" name="order">${message("csh.brand.order")}</a>
													</th>
													<th>
											...
											<tbody>
												[#list page.content as brand]
													<tr>
														...
														<td>
															[#if brand.type == "image"]
																<a href="${brand.logo}" target="_blank">${message("csh.common.view")}</a>
															[#else]
																-
															[/#if]
														</td>
														...
														<td>
															<a href="edit.jhtml?id=${brand.id}" title="${message("csh.common.edit")}"><i class="fa fa-pencil-square-o"></i></a>
														</td>
													</tr>
												[/#list]
											</tbody>
