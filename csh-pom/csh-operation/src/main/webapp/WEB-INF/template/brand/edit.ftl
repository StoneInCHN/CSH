...
<head>
<title>${message("csh.brand.edit")}</title>
            ...
            <div class="col-md-12">
              <div class="widget wgreen">
                <div class="widget-head">
                  <div class="pull-left"><i class="fa fa-plus"></i>${message("csh.brand.edit")}</div>
                     ...
                     <form id="inputForm" action="update.jhtml"  method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
                     	...
                     	<table class="input tabContent">
								<tr>
									...
									<td>
										<input type="text" name="name" value="${brand.name}" class="text" maxlength="200" />
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<span class="fieldSet">
											<input type="file"  name="imgFile"  maxlength="200" />
										</span>
									</td>
								</tr>
								<tr>
								<th>
									<span class="requiredField">*</span>${message("csh.brand.logo")}:
								</th>
								<td>
									<a href="${brand.logo}" target="100"><img src="${brand.logo}" alt="logo" style="width:100px;height:100px"><a>
								</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<input type="text" name="url" value="${brand.url}" class="text" maxlength="200" />
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<input type="text" name="order" value="${brand.order}" class="text" maxlength="9" />
									</td>
								</tr>
								<tr>
									<th>
									...
									<td>
										<textarea id="editor" name="introduction" class="editor" rows="7">${brand.introduction}</textarea>
									</td>
								</tr>
						</table>
						<table class="input">
