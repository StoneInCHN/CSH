						  ...
						  <div class="col-xs-12 col-md-12 col-lg-12">
						  		<div class="input-group">
								      <div class="input-group-btn">
								        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">${message("csh.tenantInfo.tenantName")}</button>
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "tenantName" || page.searchProperty ==null] selected="selected" class="active" [/#if] title="tenantName"><a href="#">${message("csh.tenantInfo.tenantName")}</a></li>
								        </ul>
								      </div>
										...
										<table id="listTable" class="table table-striped table-bordered table-hover">
											<thead>
												<tr>
													...
													<th>
														<a href="javascript:;" class="sort" name="tenantInfoAddress">${message("csh.tenantInfo.contactPerson")}</a>
													</th>
													<th>
