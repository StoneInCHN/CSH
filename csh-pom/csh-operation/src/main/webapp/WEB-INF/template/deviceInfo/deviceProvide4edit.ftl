...
<body>
<div class="mainbar">
			<form id="listForm" action="deviceProvide4edit.jhtml" method="get">
...
<script type="text/javascript">
	$(function(){
	   ...
	   $operationModalOK.unbind("click")
	  $operationModalOK.bind("click",function(){
	  	...
	  	var datas={
	  		...
	  		"id":$deviceBinding.attr("data-id")
	  	};
	  	$.post("provide4edit.jhtml", datas,function(result){
