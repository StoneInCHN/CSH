						  		...
						  		<div class="input-group">
								      <div class="input-group-btn">
								        ...
								        <ul class="dropdown-menu menuWrap" id="searchPropertyOption" role="menu">
								          <li [#if page.searchProperty == "tenantName" || page.searchProperty ==null] selected="selected" class="active" [/#if] title="username"><a href="#">${message("csh.distributor.tenantName")}</a></li>
								        </ul>
								      </div>
