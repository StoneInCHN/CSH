...
<head>
<title>${message("csh.faultCode.list")}</title>
...
<div class="mainbar">
				<div class="page-head">
					<div class="bread-crumb">
						...
						<span  class="bread-current"><i class="fa fa-list"></i>${message("csh.faultCode.list")}(${message("csh.page.total", page.total)})</span>
					</div>
			              ...
			              <div class="col-md-12">
			                <div class="widget">
									 <div class="widget-head">
						                  <div class="pull-left"><i class="fa fa-list"></i>${message("csh.main.faultCode")}</div>
						              ...
						              <div class="widget-content">
										<table id="listTable" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												[#list page.content as faultCode]
												<tr>
													<td>
