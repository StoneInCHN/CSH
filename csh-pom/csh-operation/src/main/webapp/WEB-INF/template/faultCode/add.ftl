...
<head>
<title>${message("csh.faultCode.add")}</title>
	...
	<div class="mainbar">
		<div class="page-head">
			<div class="bread-crumb">
				...
				<a href="list.jhtml" class="bread-current"><i class="fa fa-list"></i>${message("csh.faultCode.list")}</a>
				<span class="divider">/</span> 
				<span  class="bread-current"><i class="fa fa-plus"></i>${message("csh.faultCode.add")}</span>
			</div>
            ...
            <div class="col-md-12">
              <div class="widget wgreen">
                <div class="widget-head">
                  <div class="pull-left"><i class="fa fa-plus"></i>${message("csh.faultCode.add")}</div>
                     ...
                     <form id="inputForm" action="save.jhtml" method="post" class="form-horizontal" role="form">
                     	<table class="input tabContent">
							...
							<tr>
								...
								<td>
									<input type="text"  name="defineCh" class="text wid380" maxlength="200"/>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text"  name="defineEn" class="text wid380" maxlength="200"/>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<input type="text"  name="scope" class="text wid380" maxlength="200"/>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<textarea name="info" cols="60" rows="5" maxlength="500"></textarea>
								</td>
							</tr>
						</table>
						<table class="input">
