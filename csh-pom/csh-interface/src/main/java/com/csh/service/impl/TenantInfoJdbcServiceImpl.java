...
public class TenantInfoJdbcServiceImpl implements TenantInfoJdbcService {
  ...
  public Page<Map<String, Object>> getTenantInfos(String lng, String lat, Pageable pageable,
    ...
    tenant_sql
        .append("SELECT distinct(cti.id),cti.latitude,cti.longitude,csc.category_name,ccs.price,ccs.promotion_price,cti.address,cti.tenant_name,cti.photo,cti.praise_rate,");
