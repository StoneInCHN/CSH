...
<script src="${base}/resources/modules/beautifyReservation.js"></script>
<script type="text/javascript" src="${base}/resources/js/datePicker/WdatePicker.js"></script>

<div>
	  <fieldset>
	    <legend>${message("csh.vehicle.search")}</legend>
	    <form id="beautifyReservation-search-form" class="search-form">
...
<table id="beautifyReservation-table-list"></table>
<div id="beautifyReservation_manager_tool">
	<div class="tool-button">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain=true onclick="beautifyReservation_manager_tool.add();">添加</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain=true onclick="beautifyReservation_manager_tool.edit();">修改</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain=true onclick="beautifyReservation_manager_tool.remove();">删除</a>
	</div>
	<div class="tool-filter"></div>
</div>
<div id="addBeautifyReservation"></div>
<div id="editBeautifyReservation"></div>
<div id="beautifyReservationDetail"></div>
