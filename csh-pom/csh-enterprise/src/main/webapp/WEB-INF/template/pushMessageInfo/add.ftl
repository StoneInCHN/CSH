<form id="addPushMessageInfo_form" method="post" >
	<input type="hidden" name="sendType" value="${sendType}">
	  <table class="table table-striped"  border="0">
    	...
    	<tr>
    		<th >筛选用户:</th>
    		<td>
    			 <input  class="easyui-textbox" id= "endUserPushFilter" />
    		</td>
    	</tr>
    	<tr>
    		<td colspan="2">
    			<select name="from" id="endUserPushMultiselect" class="js-multiselect form-control" size="8" multiple="multiple">
				</select>
    		</td>
    		<td>
    		...
    		<td colspan="2">
    			<select id="endUserPushMultiselect_to" class="form-control" size="8" multiple="multiple"></select>
    		</td>
    	</tr>
    	<tr>
    		<th >内容:</th>
