...
<div title="按天">
	...
	<div style="height:auto;width: 95%;margin-left:2%">
		<div id="repareStatisticsReportId" style="height:65%;margin:2%"></div>
		<table id = "reportRepareStatistics-table-list" class="table table-striped"> </table>
	</div>
</div>
<div title="按月" >
	<div style="height:auto;width: 95%;margin-left:2%;margin-top:1%">
	  <fieldset>
	  <legend>报表查询</legend>
	    <form id="monthly_report_repare_form" class="search-form">
			<div class="search-item">
			    <label> 搜索最近 :</label>
		...
		<div class="search-item">
	  	  <button id="monthly_report_repare_search_btn" class="easyui-linkbutton" data-options="iconCls:'icon-search'">${message("csh.search")}</button>
	    </div>
	  </fieldset>
	</div>
	<div  style="width: 95%">
		<div id="monthlyReportRepareID" style="width:1000px;margin:2%"></div>
		<table id = "monthlyRreportRepare-table-list" class="table table-striped"> </table>
	</div>
</div>