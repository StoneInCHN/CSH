...
<input type="hidden" name="endUserID" id="editRepareReservation_endUserID">
    <table class="table table-striped"  border="0">
	    <tr>
    		<th>${message("csh.vehicle.endUser")}:</th>
    		<td >
    			 <input  class="easyui-textbox"  id= "editRepareReservation_endUser"  data-options="required:true,editable:false"/>
    			 <a href="#" id="endUser_search_btn" class="easyui-linkbutton" onclick="searchEndUser('editRepareReservation_endUser')" iconCls="icon-search" plain=true"></a>
    		</td>
