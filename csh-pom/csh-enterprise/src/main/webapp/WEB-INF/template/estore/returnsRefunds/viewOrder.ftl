	<div id="viewOrderTab" data-options="tabPosition:'top',headerWidth:100" class="easyui-tabs">  
		<div title="${message("csh.order")}${message("csh.details")}" style="padding:10px;text-align: centor;">
		...
		<div title="${message("csh.shipping")}" style="padding:10px;text-align: centor;">
		...
		<div title="${message("csh.returns")}" style="padding:10px;text-align: centor;">
		...
		<div title="${message("csh.refunds.refunds")}" style="padding:10px;text-align: centor;">
	    ...
	    <div title="${message("csh.action")}${message("csh.log")}" style="padding:10px;text-align: centor;">
			   <table  class="easyui-datagrid"   fitColumns="true" style="width:100%;height:auto;">
				<thead>
					<tr>
