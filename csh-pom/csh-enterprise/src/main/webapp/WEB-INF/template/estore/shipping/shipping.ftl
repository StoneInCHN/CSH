...
<div class="easyui-layout" data-options="fit:true">
      		<div data-options="region:'west',split:true" style="width:50%">
             			<div id="order-panel" class="easyui-panel" title="${message("csh.shipping.order")}"    style="width:100%;height:70%;background:#fafafa;"  data-options="collapsible:true">									
									<fieldset style="padding:5px 0px 4px 4px;margin:0px">
								        <form id="shipping-order-search-form" class="search-form">
											<div class="search-item">
											   ...
											   <input type="text" class="easyui-textbox"  name="sn" validtype="length[0,20]"/>
											</div>
										</form>
										<div class="search-item">
									...
									<div id="shipping-order_manager_tool">
										<div class="tool-button">
											<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain=true onclick="shipping-order_manager_tool.add();">${message("csh.button.shipping")}</a>
										</div>
										<div class="tool-filter"></div>
									</div>
					                <table id="shipping-order-table-list"></table>
			 			</div>
						<div id="orderItem-panel" class="easyui-panel" title="${message("csh.shipping.orderItem")}"  style="width:100%;height:30%;background:#fafafa;"  data-options="collapsible:true">
										<table id="shipping-orderItem-table-list"  fitColumns="true" style="width:100%;height:auto;">
											<thead>
												<tr>
													<th field="orderSn" width="20%"  align="center">${message("csh.shipping.sn")}</th>
													<th field="productSn" width="20%"  align="center">${message("csh.product.sn")}</th>
													<th field="name"  width="20%"  align="center">${message("csh.order.name")}</th>
													<th field="quantity" width="20%"   align="center">${message("csh.quantity")}</th>
													<th field="price" width="20%"   align="center">${message("csh.price")}</th>
												</tr>
											</thead>
										</table>
						</div>
			...
			<div data-options="region:'center'" style="width:50%">
             			<div id="shipping-panel" class="easyui-panel" title="${message("csh.shipping.shipping")}"    style="width:100%;height:70%;background:#fafafa;"  data-options="collapsible:true">	
									<fieldset style="padding:5px 0px 4px 4px;margin:0px">
						...
						<div id="shippingItem-panel" class="easyui-panel" title="${message("csh.shipping.shippingItem")}"  style="width:100%;height:30%;background:#fafafa;"  data-options="collapsible:true">
										<table id="shippingItem-table-list"  fitColumns="true" style="width:100%;height:auto;">
											<thead>
												<tr>
													...
													<th field="name"  width="25%"  align="center">${message("csh.order.name")}</th>
