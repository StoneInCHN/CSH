...
<div id="deviceInfo_manager_tool">
	<div class="tool-button">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain=true onclick="deviceInfo_manager_tool.deviceStatusUpdate('SALEOUT');">售出</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain=true onclick="deviceInfo_manager_tool.deviceStatusUpdate('REFUNDED');">退回</a>
