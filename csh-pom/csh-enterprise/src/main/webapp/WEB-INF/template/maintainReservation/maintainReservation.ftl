...
<script src="${base}/resources/modules/maintainReservation.js"></script>
...
<table id="maintainReservation-table-list"></table>
<div id="maintainReservation_manager_tool">
	<div class="tool-button">
		<a href="#" class="easyui-linkbutton" iconCls="icon-add" plain=true onclick="maintainReservation_manager_tool.add();">添加</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain=true onclick="maintainReservation_manager_tool.edit();">修改</a>
		<a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain=true onclick="maintainReservation_manager_tool.remove();">删除</a>
	</div>
	<div class="tool-filter"></div>
</div>
<div id="addMaintainReservation"></div>
<div id="editMaintainReservation"></div>
<div id="maintainReservationDetail"></div>
