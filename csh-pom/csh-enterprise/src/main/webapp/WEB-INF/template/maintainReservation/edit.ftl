<form id="editMaintainReservation_form" method="post">   
	    ...
	    <table class="table table-striped"  border="0">
		    ...
		    <tr>
	    		...
	    		<td>
	    			 <input  class="easyui-textbox" id= "endUserMobileNum" value="${maintainReservation.endUser.mobileNum}"  data-options="required:true"  validtype="mobile"/>
	    		</td>
	    	</tr>
	    	<tr>
	    	...
	    	<tr>
	    		<th>预约时间:</th>
	    		<td colspan="5">
	    			 <input  class="easyui-datebox" value="${maintainReservation.reservationDate}" name="reservationDate" id= "reservationDate"  data-options="required:true,editable:false"/>
	    		</td>
