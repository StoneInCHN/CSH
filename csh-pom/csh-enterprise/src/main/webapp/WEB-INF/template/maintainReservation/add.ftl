<form id="addMaintainReservation_form" method="post" >
	<input type="hidden" name="endUserID" id="maintainReservation_endUserID">  
	  <table class="table table-striped"  border="0">
	    <tr>
    		<th>${message("csh.vehicle.endUser")}:</th>
    		<td >
    			 <input  class="easyui-textbox"  id= "maintainReservation_endUser"  data-options="required:true,editable:false"/>
    			 <a href="#" id="endUser_search_btn" class="easyui-linkbutton" onclick="searchEndUser('maintainReservation_endUser')" iconCls="icon-search" plain=true"></a>
    		</td>
