...
public class LatLonUtil {
 ...
 /* public static Map<String, Object> convertCoordinateForBaiDuLbs(String lon, String lat) {
  ...
  public static List<Map<String, Object>> convertCoordinates (
    ...
    try
    {
      ...
      for (int i = 0; i < newMapsList.size (); i++)
      {
        ...
        String url = setting.getConvertMutipleMapUrl () + "?from=1&to=5&ak="
            ...
            + corrds.substring (0, corrds.length () - 1);
        //        String url ="http://api.map.baidu.com/geoconv/v1/?coords=114.21892734521,29.575429778924;114.21892734521,29.575429778924&from=1&to=5&ak=ulsOtfMZcNc4D6aQnBwwnOTt6ZKohflO";
        String res = ApiUtils.get (url);
        ObjectMapper mapper = new ObjectMapper ();
        Map<String, Object> resMap = (Map<String, Object>) mapper.readValue (
            res, Map.class);
