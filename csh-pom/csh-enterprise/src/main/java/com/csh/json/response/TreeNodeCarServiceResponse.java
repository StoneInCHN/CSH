 ...
 */
public class TreeNodeCarServiceResponse {
   ...
   * children: 一个节点数组声明了若干节点。
   */
  private List<TreeNodeCarServiceResponse> children;
  ...
  public List<TreeNodeCarServiceResponse> getChildren() {
    return children;
  }

  public void setChildren(List<TreeNodeCarServiceResponse> children) {
